...
import 'package:mawjood/components/button.dart';
import 'package:mawjood/components/theme.dart';
import 'package:flutter_svg/svg.dart';

import 'package:mawjood/components/kfupm_logo.dart';
import 'package:mawjood/components/spaces.dart';
import 'package:mawjood/screens/landing_page/ax_step.dart';
import 'package:mawjood/screens/landing_page/landing_slide.dart';
      ...
      body: AxLandingPage(
        ...
        slides: [
          AxLandingSlide(
            ...
            subtitle: 'Easily report any lost or found belongings to help others recover what matters.',
          ...
          AxLandingSlide(
            ...
            subtitle: 'Stay updated on the status of your reported items and view claim progress in real-time.',
            totalNumberOfSlides: 4,
          ),
          AxLandingSlide(
            illustrationPath: 'comunity.png',
            slideIndex: 3,
            title: 'Search the Lost & Found Database',
            subtitle: 'Browse reported items by category, date, or location to quickly find matches.',
            totalNumberOfSlides: 4,
          ),
          AxLandingSlide(
            ...
            subtitle: 'Facilitate secure communication and item handoff between finders and owners.',
            totalNumberOfSlides: 4,
          ),
        ],
